...
export const i18nStrings = {
    ...
    CONFIRM_TOTP: 'Two Factor Authentication is enabled',
    CONFIRM_TOTP_HELPTEXT: 'Please enter code displayed on your Authenticator App',
    ...
    LANDING_PAGE_BUTTON_IDP_SIGNINWITHAPPLE_LABEL: 'Sign In with Apple',
    LANDING_PAGE_BUTTON_IDP_AZUREAD_SIGNIN_LABEL: 'Sign In with Azure',
    ...
    TAB_MFA_DATA_LABEL: 'Configure MFA',
    ...
    TAB_SIGNIN_DATA_MESSAGE_ERROR: 'An error has occurred',
    ...
    HEADER_MENU_ITEM_CHANGE_PASSWORD: 'Change Password',
