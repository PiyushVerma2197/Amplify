...
export const i18nStrings = {
  ...
  CONFIRM_TOTP: 'Tweefactorauthenticatie is ingeschakeld',
  CONFIRM_TOTP_HELPTEXT: 'Voer de code in die wordt weergegeven in uw Authenticator-app',
  ...
  LANDING_PAGE_BUTTON_IDP_SIGNINWITHAPPLE_LABEL: 'Aanmelden met Apple',
  LANDING_PAGE_BUTTON_IDP_AZUREAD_SIGNIN_LABEL: 'Aanmelden met Azure',
  ...
  TAB_MFA_DATA_LABEL: 'MFA configureren',
  TAB_MFA_DATA_SELECT_MFA_TYPE: 'Configureer uw favoriete MFA-type',
  TAB_MFA_DATA_SELECT_TOTP: 'Authenticator-app',
  ...
  TAB_SIGNIN_DATA_MESSAGE_ERROR: 'Er is een fout opgetreden',
  ...
  HEADER_MENU_ITEM_CHANGE_PASSWORD: 'Verander wachtwoord',
  ...
  VERIFY_DIALOG_INPUT_LABEL: 'Please enter the code',
